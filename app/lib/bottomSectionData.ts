...
export const bottomSectionData = {
  ...
  faq: {
    ...
    href2: "/",
    button2Text: "Home",
    title: "Discover More About Our Products",
    desc: "If you have any more questions or need further assistance, feel free to reach out to our customer service team. We are here to help you find the best nutrition for your pets.",
  },
  home: {
    href1: "/products",
    button1Text: "Products",
